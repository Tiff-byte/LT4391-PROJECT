...
df = pd.read_csv("WRITTEN_CHI_QUESTION_FYP1.csv", encoding='utf-8-sig')
...
result_df.to_csv("answer_q4.csv", index=False, encoding='utf-8-sig')
print(f"\n✅ Done! {len(answers)} answers saved to answer_q4.csv")