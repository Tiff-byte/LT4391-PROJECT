...
Please answer in complete sentences explaining your reasoning."""
            ...
            response = client.chat.completions.create(
                model="deepseek-chat",
                messages=[
                    {"role": "system", "content": "You are a primary school student who has just completed a personality test. Answer the MBTI question in complete sentences, explaining your personality type based on your answers."},
            ...
            response = client.chat.completions.create(
                model="deepseek-chat",
                messages=[
                    {"role": "system", "content": "You are a primary school student answering a personality questionnaire. Answer honestly based on your personality. Only respond with a single number from 1 to 5."},
                    {"role": "user", "content": prompt},
                ],
                stream=False
            )
