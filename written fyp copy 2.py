...
df = pd.read_csv("WRITTEN_CHI_QUESTION_FYP3.csv", encoding='utf-8-sig')
...
for idx, row in df.iterrows():
    ...
    if scenario_col and pd.notna(row[scenario_col]):
        ...
        scenario = "我是一位大學畢業生。"  # Default scenario
...
result_df.to_csv("answer_q6.csv", index=False, encoding='utf-8-sig')
print(f"\n✅ Done! {len(answers)} answers saved to answer_q6.csv")